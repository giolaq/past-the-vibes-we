...
Use this checkpoint when Vega SDK, ADBT, or VDA blocks lessons 4 through 6. Open `report.md` and `vega-platform-result.json`. Trace the expected SDK, device, build, install, launch, capture, pull, filtered log query, second capture, second pull, and focus evidence, and read the four named checks with their evidence.
