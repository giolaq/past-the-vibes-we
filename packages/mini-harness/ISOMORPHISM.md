...
| `skills.ts` | `packages/workshop-harness/skills/react-native-tv-adaptation/SKILL.md` | Keeps domain instructions separate from pipeline code. | Dedicated discovery, TV adaptation, and Vega portability skills. |
